...
def poth_graph(symbol, data, indicator):
    ...
    if indicator == "BULLMARKET":
        ap = [
                mpf.make_addplot(data['SMA20'], ax=ax, color='orange', linestyle='--', width=0.5),
                mpf.make_addplot(data['EMA21'], ax=ax, color='orange', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCL'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCU'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCH'], ax=ax, color='grey', linestyle='--', width=0.5),
            ]
    elif indicator == "BOLLINGER":
        ap = [
                mpf.make_addplot(data['UpperBand'], ax=ax, color='orange', linestyle='--', width=0.5),
                mpf.make_addplot(data['LowerBand'], ax=ax, color='orange', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCL'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCU'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCH'], ax=ax, color='grey', linestyle='--', width=0.5),
            ]
        ...
        ap = [
                mpf.make_addplot(data['Supertrend'], ax=ax, color='orange', width=0.5),
                mpf.make_addplot(data['DCL'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCU'], ax=ax, color='grey', linestyle='--', width=0.5),
                mpf.make_addplot(data['DCH'], ax=ax, color='grey', linestyle='--', width=0.5),
            ]
    ...
    mpf.plot(
        ...
        tight_layout=True,
        # fill_between=dict(y1=data['low'].values,y2=data['high'].values,color='g')
    )

    # mpf.fill_between(y1=data['low'], y2=data['high'], color='green',alpha=0.5)
    ...
    # if indicator == "BULLMARKET":
    #     ax.fill_between(data.index, data['EMA21'], data['SMA20'], where=(data['EMA21'] > data['SMA20']), color='green', alpha=0.2, label='Uptrend')
    #     ax.fill_between(data.index, data['EMA21'], data['SMA20'], where=(data['EMA21'] < data['SMA20']), color='red', alpha=0.2, label='Uptrend')
    # elif indicator == "BOLLINGER":
    #     ax.fill_between(data.index, data['LowerBand'], data['UpperBand'], color='yellow', alpha=0.2, label='Bollinger Band')
    # elif indicator == "SUPERTREND":
    #     ax.fill_between(data.index, data['close'], data['Supertrend'], where=(data['close'] > data['Supertrend']), color='green', alpha=0.2, label='Uptrend')
    #     ax.fill_between(data.index, data['close'], data['Supertrend'], where=(data['close'] < data['Supertrend']), color='red', alpha=0.2, label='Downtrend')
